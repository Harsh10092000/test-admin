...
if(isset($_POST["submit"])) {
   ...
   // $sql = "select * from login where u_name = '$userName' and u_pass = '$password'";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <!-- <img src="assets/images/logo/logo.png" alt="dfgdf"> -->
                  <span class="d-none d-lg-block">Quality Solutions</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" novalidate action="#" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="user-name" class="form-control" id="yourUsername" required>
